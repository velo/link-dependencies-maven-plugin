...
public class TestSourcesMarkerFileHandler
    ...
    public void doTestMarkerTimeStamp(boolean resolved)
        ...
        SourcesFileMarkerHandler resolvedHandler = new SourcesFileMarkerHandler(artifacts.get(0), this.outputFolder, resolved);
        SourcesFileMarkerHandler unResolvedHandler = new SourcesFileMarkerHandler(artifacts.get(0), this.outputFolder, !resolved);
    ...
    public void testMarkerFileException() {
        ...
        StubSourcesFileMarkerHandler handler = new StubSourcesFileMarkerHandler(artifacts.get(0), this.outputFolder, true);
        try {
            handler.setMarker();
