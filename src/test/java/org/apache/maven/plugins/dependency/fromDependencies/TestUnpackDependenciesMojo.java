...
public class TestUnpackDependenciesMojo
    ...
    public void assertUnpacked(boolean val, Artifact artifact) {
        File folder = DependencyUtil.getFormattedOutputDirectory(mojo.useSubDirectoryPerScope, mojo.useSubDirectoryPerType,
    ...
    public void dotestClassifierType(String testClassifier, String testType)
        ...
        for (Artifact artifact : mojo.getProject().getArtifacts()) {
            ...
            Artifact unpacked = stubFactory.createArtifact(artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion(),
